...
describe('DevOpsMCPServer - handleGetStatusWorkflow', () => {
    ...
    describe('Éxito', () => {
        it('debería obtener el estado de un workflow cuando la operación es exitosa', async () => {
            ...
            expect(mockGithubClient.getStatusWorkflow).toHaveBeenCalledWith('test-repo', 123);
        ...
        it('debería manejar IDs de workflow muy grandes', async () => {
            ...
            // Assert
            expect(mockGithubClient.getStatusWorkflow).toHaveBeenCalledWith('test-repo', largeId);
    ...
    describe('Errores', () => {
        ...
        it('debería manejar errores al obtener el estado del workflow', async () => {
            ...
            mockGithubClient.getStatusWorkflow.mockRejectedValue(new Error(errorMessage));
    ...
    describe('Casos edge', () => {
        it('debería manejar nombres de repositorio con caracteres especiales', async () => {
            ...
            // Assert
            expect(mockGithubClient.getStatusWorkflow).toHaveBeenCalledWith('repo-with-special-chars-@#$%', 123);
            expect(result.content[0].text).toContain('"status": "completed"');
        });
        ...
        it('debería manejar IDs de workflow negativos', async () => {
            ...
            // Assert
            expect(mockGithubClient.getStatusWorkflow).toHaveBeenCalledWith('test-repo', -1);
        ...
        it('debería manejar IDs de workflow cero', async () => {
            ...
            // Assert
            expect(mockGithubClient.getStatusWorkflow).toHaveBeenCalledWith('test-repo', 0);
            expect(result.content[0].text).toContain('"status": "failed"');
        });
        ...
        it('debería manejar parámetros con valores undefined', async () => {
            ...
            // Assert
            expect(mockGithubClient.getStatusWorkflow).toHaveBeenCalledWith('test-repo', undefined);
            expect(result.content[0].text).toContain('"status": "completed"');
        });
