...
describe('DevOpsMCPServer - handleShowWorkflows', () => {
    ...
    describe('Éxito', () => {
        it('debería retornar los workflows cuando la operación es exitosa', async () => {
            ...
            mockGithubClient.getDataWorkflows.mockResolvedValue(mockWorkflows.workflow_runs);
            ...
            expect(mockGithubClient.getDataWorkflows).toHaveBeenCalledWith('test-repo');
    ...
    describe('Errores', () => {
        ...
        it('debería manejar errores al obtener workflows', async () => {
            ...
            mockGithubClient.getDataWorkflows.mockRejectedValue(new Error(errorMessage));
    ...
    describe('Casos edge', () => {
        it('debería manejar nombres de repositorio con caracteres especiales', async () => {
            ...
            // Assert
            expect(mockGithubClient.getDataWorkflows).toHaveBeenCalledWith('repo-with-special-chars-@#$%');
