...
describe('DevOpsMCPServer - handleShowContentFiles', () => {
    ...
    describe('Éxito', () => {
        it('debería retornar el contenido de los archivos cuando la operación es exitosa', async () => {
            ...
            expect(mockGithubClient.getContentFiles).toHaveBeenCalledWith('test-repo', 'package.json');
    ...
    describe('Errores', () => {
        ...
        it('debería manejar errores al obtener el contenido de archivos', async () => {
            ...
            mockGithubClient.getContentFiles.mockRejectedValue(new Error(errorMessage));
    ...
    describe('Casos edge', () => {
        it('debería manejar nombres de repositorio con caracteres especiales', async () => {
            ...
            // Assert
            expect(mockGithubClient.getContentFiles).toHaveBeenCalledWith('repo-with-special-chars-@#$%', 'test.txt');
        ...
        it('debería manejar rutas de archivo con caracteres especiales', async () => {
            ...
            // Assert
            expect(mockGithubClient.getContentFiles).toHaveBeenCalledWith('test-repo', 'folder with spaces/special@file#.txt');
        ...
        it('debería manejar rutas de archivo muy largas', async () => {
            ...
            // Assert
            expect(mockGithubClient.getContentFiles).toHaveBeenCalledWith('test-repo', longPath);
        ...
        it('debería manejar parámetros con valores undefined', async () => {
            ...
            // Assert
            expect(mockGithubClient.getContentFiles).toHaveBeenCalledWith('test-repo', undefined);
            expect(result.content[0].text).toContain('Test content');
        });
